...
from .desktop_pet import DesktopPet, validate_image_folders, PetAnimationState
from .chat_dialog import ChatDialog, QuickChatDialog
from .model_expander_ui import ModelExpanderDialog  # 新建的檔案，見下
...
class SmartDesktopPetApp:
    ...
    def _init_pet_widget(self):
        ...
        try:
            # 載入動畫資源
            idle_images, walk_images, take_images, errors = validate_image_folders("app/Idle", "app/Walk", take_folder="app/Take")
